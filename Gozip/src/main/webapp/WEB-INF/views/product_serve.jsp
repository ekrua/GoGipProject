			...
			<div class="ps_content">
				<div class="ps_heading">
					...
					<div class="ps_description">
						<div class="ps_title">이모티콘명</div>
						<div class="ps_text">이모티콘 설명 부분 이모티콘 설명 부분 이모티콘 설명 부분 이모티콘
							설명 부분 이모티콘 설명 부분 이모티콘 설명 부분 이모티콘 설명 부분 이모티콘 설명 부분 이모티콘 설명 부분 이모티콘
							설명 부분 이모티콘 설명 부분</div>
						<div class="ps_btn">
