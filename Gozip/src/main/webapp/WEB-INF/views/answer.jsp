							...
							<div class="a-heading_title">
								<div class="a-heading_title_inner">
									<div class="title">
										...
										<div class="title-text">제목부분 입니다.</div>
									</div>
								</div>
								<!--a-heading_title_inner 영역 -->
							</div>
							<!-- a-heading_title 영역 -->
							<div class="a-heading_content">글 내용 적는 부분입니다. 글 내용을 적어주세요.

							</div>
							<!-- a-heading_content 영역 -->
						</div>
						<!-- a-heading 영역 -->
						<div class="a-userinfo">
							<div class="a-userinfo_proofile _profileArea">작성자 닉네임</div>
							<!-- _profileArea 영역 -->
						...
						<div class="answer-content_inner">
							<div class="answer-content_list">
								<div class="answer_1 answer-content_item">
									<div class="description">답변자 닉네임</div>
									<p class="a-text">답변 글 내용 적혀있는 부분입니다.</p>
							...
							<!-- answer-content_list 영역 -->
						</div>
						<!-- answer-content_inner 영역 -->
					</div>
					<!-- anserArea 영역 -->
				</div>
				<!-- ask_wrap 영역 -->
