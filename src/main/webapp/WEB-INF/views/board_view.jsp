...
<body>
	<!-- 제목 -->
	<h2>${requestScope.dto.btitle }</h2>
	<!-- 작성자 작성일 좋아요 싫어요 -->
	<p>작성자 : ${requestScope.dto.bwriter}, 작성일 : ${requestScope.dto.bdate}</p>
	<p>조회수 : ${requestScope.dto.bcount}, 좋아요 : <a class="like">${requestScope.dto.blike}</a></p>
	<!-- 내용 -->
	<p>
		${requestScope.dto.bcontent}
	</p>
	<button id="btnBack">뒤로가기</button>
	<c:if test="${requestScope.dto.bwriter == sessionScope.member.id }">
