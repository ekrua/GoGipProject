	...
	<form action="updateMember.do" method="POST">
			...
			<div class="form-group">
				<label for="user_id">아이디</label><br>
					<input type="text" class="form-control" id="${sessionScope.member.id}" name="id" placeholder="${sessionScope.member.id}" value="${sessionScope.member.id}" readonly="readonly">
